      ...
      <div className="flex flex-no-wrap">
        {deviceType === "desktop" && (
          <div
            ...
            className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between flex"
          >
            <div className="px-8">
              <ul className="mt-12">
        ...
        {deviceType === "mobile" && (
          <div
            ...
            id="mobile-nav"
            // Apply transition when nav is open
            style={{
          ...
          >
            ...
            <button
              ...
              onClick={() => setIsOpen((open) => !open)}
              // style={{
              //   transform: !isOpen && "translateX(-260px)",
              // }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
